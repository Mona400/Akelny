        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subscriptions_PaymentDetails_PaymentDetailsVisaNumber",
                        column: x => x.PaymentDetailsVisaNumber,
                        principalTable: "PaymentDetails",
                        principalColumn: "VisaNumber");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantID = table.Column<int>(type: "int", nullable: true),
                    RestTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RestImg = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Meals_and_Dates_Restaurant_RestaurantID",
                        column: x => x.RestaurantID,
                        principalTable: "Restaurant",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Promotions",
                columns: new[] { "Id", "Description", "ImageUrl", "PriceAfter", "PriceBefore", "Title", "date" },
                values: new object[] { 1, "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).", "test_sand.jpg", 200.99m, 259.99m, "Burger Sandwich", new DateTime(2023, 8, 11, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Restaurant",
                columns: new[] { "Id", "Description", "Image", "Rating", "Speciality", "Title" },
                values: new object[,]
                {
                    { 1, "Description1", "507a9056-bf91-4616-8036-f8443aaf41d7.jpg", 10.2m, "Speciality1", "Title1" },
                    { 2, "Description2", "507a9056-bf91-4616-8036-f8443aaf41d7.jpg", 10.2m, "Speciality2", "Title2" },
                    { 3, "Description3", "507a9056-bf91-4616-8036-f8443aaf41d7.jpg", 10.2m, "Speciality3", "Title3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Meal Des1", "test.png", "Meal Name1", 120.2m, 1, 1 },
                    { 2, "Meal Des2", "test.png", "Meal Name2", 120.2m, 1, 2 },
                    { 3, "Meal Des3", "test.png", "Meal Name3", 120.2m, 1, 1 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Meals_and_Dates_RestaurantID",
                table: "Meals_and_Dates",
                column: "RestaurantID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_PaymentDetailsVisaNumber",
                table: "Subscriptions",
                column: "PaymentDetailsVisaNumber");
